                    ...
                    if (layoutParams2.circleConstraint != -1) {
                        ...
                        if (resolvedLeftToLeft2 != -1) {
                            ...
                            if (target6 != null) {
                                ...
                                View view3 = child3;
                                layoutParams = layoutParams2;
                                widget2.immediateConnect(type, constraintWidget, type2, layoutParams2.leftMargin, resolveGoneLeftMargin2);
                            } else {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (sizeDependentWidgetsCount > 0) {
            ...
            while (i7 < sizeDependentWidgetsCount) {
                ...
                ConstraintWidget widget = this.mVariableDimensionsWidgets.get(i7);
